...
const Seller_navber = ({
  ...
  return (
    <div className=" w-full dark:bg-slate-900 bg-white py-5 px-6 border-b-[0.01] ">
      ...
      <div className=" flex items-center justify-start gap-6">
        ...
        <div>
          <span className=" flex items-center justify-start gap-1">
            ...
            <p className=" text-lg dark:text-gray-400 text-gray-500 font-semibold capitalize">
              {" "}
              Deahboard
            </p>
          </span>
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <div className=" flex gap-1">
          <Popover>
            ...
            <PopoverContent className=" w-full text-sm" align="end">
              ...
              <div className="flex items-start justify-start flex-col gap-5">
                <div>
                  ...
                  <p className=" text-sm capitalize">
                    {hasRole(user?.roles, "admin") ? "admin" : "user"}
                  </p>
                </div>
                <AlertDialog>
