                    ...
                    >
                        ...
                        <div className=" relative">
                            <button
                                ...
                                className={`text-2xl font-bold hover:text-blue-500 duration-200 ${isAddToCartOpen ? "text-blue-500" : " text-black"
                                    }`}
                            >
                                <LuShoppingCart />
                            </button>
                                        ...
                                        <ul className="space-y-3 text-sm text-gray-700">
                                            ...
                                            <li className="border-t border-gray-200 pt-3">
                                                <h1
                                                    ...
                                                    className=" cursor-pointer block hover:text-blue-500 transition-colors"
                                                >
                                                    Create an Account
                                                </h1>
                                            </li>
