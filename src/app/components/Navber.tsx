...
import { accountNavagationLink, NavLink as navLink } from "../data/navegationLinks";
        ...
        <nav className="border-b border-b-gray-300 bg-white py-5 px-4 lg:px-5 xl:px-[10%] flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center justify-center gap-6 relative pr-0 md:px-10">
            ...
            <div className="relative" ref={cartRef}>
              <button
                onClick={toggleCart}
                className={`text-2xl font-bold hover:text-blue-500 duration-200 ${isCartOpen ? "text-blue-500" : "text-black"
                  }`}
              >
                <LuShoppingCart />
              </button>
...
const MobileNavItem = ({ item, index }: { item: any; index: number }) => {
  ...
  return (
    <h4 className="w-full py-3 border-b border-gray-200">
      <div
