...
const WishlistNew = () => {
  ...
  return (
    <>
      <div className=" py-4 flex flex-col items-start justify-between h-full">
        ...
        <div className="py-5 w-full flex items-center justify-center flex-col gap-0 max-h-full">
          {loading ? (
            <p>Loading...</p>
          ) : error ? (
